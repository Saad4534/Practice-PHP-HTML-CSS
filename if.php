     ...
     <main class="container">
        <h1><?php echo TITLE; ?></h1>
         ...
         <?php
            ...
            $currentlyListeningTo = "Atif Aslam";
            if($currentlyListeningTo == "Arijit Singh"){
                echo "You are listening to $currentlyListeningTo";
            }else{
                echo "Taking a wild guess here, you are listening to $currentlyListeningTo <br>";
            }
         
            $favLang = "JAVA";
         
            if($favLang == "C++"){
                echo "You are quite a coder";
            }elseif($favLang == "PHP"){
                echo "Oh, you are learning PHP";
            }else{
                echo "I guess you dont like coding";
            }
